...
void KDevVLSIDoc::changedViewList(){	
...
const KURL& KDevVLSIDoc::URL() const
{
  return doc_url;
}

void KDevVLSIDoc::closeDocument()
{
  KDevVLSIView *w;
  if(!isLastView())
  {
...
void KDevVLSIDoc::deleteContents()
{
  /////////////////////////////////////////////////

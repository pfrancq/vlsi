...
/**
  * The base class for KDevVLSI application windows. It sets up the main
  ...
  * display whereby one document can have several views.The MDI child is an instance of KDevVLSIView,
  * the document an instance of KDevVLSIDoc.
  * KDevVLSIApp reimplements the methods that KTMainWindow provides for main window handling and supports
...
class KDevVLSIApp : public KMainWindow
{
  ...
  public:
    /** construtor of KDevVLSIApp, calls all init functions to create the application.
